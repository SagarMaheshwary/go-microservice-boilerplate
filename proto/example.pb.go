...
const file_proto_example_proto_rawDesc = "" +
	"\n" +
	"\x13proto/example.proto\x12\aexample\"\x0e\n" +
	"\fHelloRequest\")\n" +
	"\rHelloResponse\x12\x18\n" +
	"\amessage\x18\x01 \x01(\tR\amessage2A\n" +
	"\aExample\x126\n" +
	"\x05Hello\x12\x15.example.HelloRequest\x1a\x16.example.HelloResponseBFZDgithub.com/SagarMaheshwary/go-microservice-boilerplate/proto/exampleb\x06proto3"
